...
while ( digitalRead(10) == HIGH){
  ...
  if (segundos == 60){segundos = 0; minutos1++; if (minutos1 == 60){minutosX = 1; minutos1 = 0; }}
  if (minutosX == 1 ){digitalWrite(13,HIGH);    if (minutos1 == 10){minutosX = 0; minutos1 = 0; minutos2 = 0;}}
